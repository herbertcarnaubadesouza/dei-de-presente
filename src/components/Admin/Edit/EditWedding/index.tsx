...
import WeddingForEdit from './WeddingForEdit';
...
export default function EditWedding({
    ...
    const handleImageFotosEvento7 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico7Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
    ...
    const handleImageFotosEvento8 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico8Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
    ...
    const handleImageFotosEvento9 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico9Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
    ...
    const handleImageFotosEvento10 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico10Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
    ...
    const handleImageFotosEvento11 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico11Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
    ...
    const handleImageFotosEvento12 = async (file: File) => {
        ...
        try {
            ...
            if (response.data.file) {
                setFotoMosaico12Url(`${response.data.file}`);
            }
        } catch (err) {
            console.error('Ocorreu um erro durante o upload:', err);
        }
                            ...
                            {bannerUrl && (
                                <div className={styles.FileSelected}>
                                    ...
                                    <div className={styles.FileSelectedStats}>
                                        <div
                                            className={styles.FileSelectedName}
                                        >
